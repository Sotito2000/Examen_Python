...
class Cinema:
    ...
    def count_free_seats(self,rows_seats,total):
        ...
        Args:
            ...
            total: valor inicial donde se acumulara el total
        Return:
            total: valor final de asientos libres
        """
...
He corregido el error realizando dos pasos:
    Paso 1: 
"""
print("------------- Error 1 -----------------")
...
#ERROR 2: le paso la lista de "seats" donde deberia haber 2 libres y me dice que hay 0.
"""
El error era que el print mostraba el total = 0 que se creaba y no era modificado por
la funcion de count_free_seats

He corregido el error realizando dos pasos:
    Paso 1: en la funcion count_free_seats, he hecho que devuelva el total de asientos vacios
    Paso 2: en el main hago que me muestre el total con el print
"""
print("\n------------- Error 2 -----------------")
seats = [(2,4), (3,1), (5,2)]
total = 0
print("total: "+str(cinema.count_free_seats(seats,total)))

#ERROR 3: quiero modificar la butaca (2,4) de la lista anterior para que sea la (3,4) y no me deja.
"""
El error era que se estaba tratando de cambiar el seats[0][1] que es el 4 del (2,4) y no el
2 del (2,4) que es lo que se pide, asi como que se estaba tratando de asignar el 3 mediante
un solo igual

He corregido el error realizando un paso:
    Paso 1: asignamos a la posicion 0 de la lista (el asiento (2,4)) el nuevo valor (3,4)
"""
print("\n------------- Error 3 -----------------")
seats[0] = (3,4)
total = 0
